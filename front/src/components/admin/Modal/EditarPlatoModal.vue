...
// id del plato (normalizamos por si viene con distintos nombres)
...
// Imagen: ruta relativa y preview
...
function guardarCambios() {
  ...
  const actualizado = {
    ...props.plato,
    id_plato, // nos aseguramos que siga teniendo este id
    nombre: nombre.value,
...
<style scoped>
/* puedes reutilizar estilos del modal de usuarios */
.overlay {
  position: fixed;
  inset: 0;
